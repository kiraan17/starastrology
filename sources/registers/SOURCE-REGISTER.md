# Source Register (initial entries)

**Version:** 0.1  
**Status:** Seed list — most classical rows need expert edition/citation fill before Approved
...
## Expert approval list (empty until reviewers assigned)

| reviewer_id | name_or_role | traditions | active |
|---|---|---|---|
| REV-PLACEHOLDER | Unassigned | — | no |
